...
class Captcha {
    ...
    /**
     * se não estiver vazia ela é destroida .
     ...
     * caso nao for indicado a quantidade o default é 6 caracteres.
    ...
    /**
     * Lê o texto e adiciona as fontes de modo random.
     * caso esteja sem configuração de fonte definida ( Vazio ) é setado a nova fonte.
     * setado rotação.
    ...
    /**
     * Identifica se a imagem é png , caso nao seja é definido como jpg;
    ...
    /**
     * esta função exige parametro $letters como Array<String>.
     ...
     * defini o cabeçalho como audio/wave , para forçar o download do arquivo ou executar no browser.
     * 
